        ...
        <div>
                <section class="bg-skyblue">
                    <div class="container px-6 py-10 mx-auto">
                        <h1 class="text-3xl font-semibold text-center text-gray-800 capitalize lg:text-4xl">Infinite Pay<br/> <span class="text-blue-500"></span></h1>
                    </div>
                    <ImageSlider images={images} />
                    <div class="grid grid-cols-1 gap-12 mt-8 xl:mt-35 xl:gap-16 md:grid-cols-2 xl:grid-cols-3">
                        ...
                        <div class="flex flex-col items-center p-6 space-y-1 text-center bg-gray-100 rounded-xl dark:bg-gray-800">
                            ...
                            <h1 class="text-2xl font-semibold text-gray-700 capitalize dark:text-white">Deposit/Withdraw</h1>
